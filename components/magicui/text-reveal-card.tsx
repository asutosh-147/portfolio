      ...
      <div className="relative flex h-40 items-center overflow-hidden">
        ...
        >
          <p
            ...
            className="bg-gradient-to-b from-white to-neutral-300 bg-clip-text p-2 py-10 text-2xl font-bold text-transparent text-white sm:text-[3rem]"
          >
            {revealText}
          </p>
        </motion.div>
        ...
        <div className="overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="bg-[#323238] dark:text-gray-200 bg-clip-text py-10 font-bold text-transparent text-2xl sm:text-[3rem]">
            {text}
          </p>
          <MemoizedStars />
        </div>
